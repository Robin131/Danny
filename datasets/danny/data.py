...
'''
    Rename all the conversations files
'''
import os, re
...
def rename_file():
    ...
    for item in os.listdir(path):
        print(item)
        os.rename(path + item, path + str(i) + '.txt')
        i += 1

'''
    Get questions and answers from conversations
    1. open all conversation files
    2. extract each QA
    3. return a list of questions and a list of answers
'''
